...
#Run Spades
/projects/home/agombolay3/data/bin/SPAdes-3.10.1-Linux/bin/spades.py --pe1-1 $path/YS486-1_R1.fastq.gz --pe1-2 $path/YS486-1_R2.fastq.gz --pe2-1 $path/YS486-2_R1.fastq.gz --pe2-2 $path/YS486-2_R2.fastq.gz --careful -o $output
