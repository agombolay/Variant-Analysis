...
awk -F'\t' '$13!='synonymous_variant' || $14!='synonymous_variant' || $15!='synonymous_variant' || $16!='synonymous_variant' || $17!='synonymous_variant' {print $0}' Variants3.tab > Variants.tab
